...
description: phased implementation directly from a structure outline, skipping plan generation - you must use this skill when asked to implement an outline file or when asked to implement from a structure outline in .humanlayer/tasks/*
---
