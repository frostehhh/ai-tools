...
**Closing question format:** End with the one question that makes their stomach drop. If the answer would be a choice between 2-4 options, present those options explicitly. Pin them down — don't let vague answers pass.
