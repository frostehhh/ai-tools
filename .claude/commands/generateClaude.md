...
First, you will be given a directory input. If the input is provided, use that as the starting point for your exploration. If no input is given, start from the root directory. Here's how to handle the directory input:

<directory_input>
#$ARGUMENTS
</directory_input>

If the <directory_input> tags contain a value, use that as your starting directory. If they are empty, assume you are starting from the root directory.

To explore the codebase, follow these steps:
